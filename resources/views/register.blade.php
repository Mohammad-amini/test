...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <form class="form col-md-4" action="/register" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="name">Name <small>(At least 6 char)</small></label></label>
                            <input type="name" name="name" id="name" class="form-control" placeholder="Enter your name here...">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <label for="repassword">Retpe Password</label>
                            <input type="password" name="repassword" id="repassword" class="form-control" placeholder="Retype password here..." minlength="6">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <hr>
                            <div class="btn-group">
                                <a class="home-link btn btn-default" href="/login">Login</a>
